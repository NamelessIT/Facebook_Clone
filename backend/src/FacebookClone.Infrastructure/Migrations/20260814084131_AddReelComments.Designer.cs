...
namespace FacebookClone.Infrastructure.Migrations
{
    ...
    [Migration("20260814084131_AddReelComments")]
    partial class AddReelComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.MarketplaceFavorite", b =>
                {
                    ...
                    b.ToTable("MarketplaceFavorites", (string)null);
                });

            modelBuilder.Entity("FacebookClone.Domain.Entities.MarketplaceListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.MarketplacePaymentTransaction", b =>
                {
                    ...
                    b.ToTable("MarketplacePaymentTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.Message", b =>
                {
                    ...
                    b.Property<Guid?>("ReplacesMessageId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.MessageHiddenForUser", b =>
                {
                    ...
                    b.ToTable("MessageHiddenForUsers", (string)null);
                });
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.ModerationReport", b =>
                {
                    ...
                    b.Property<DateTime?>("PunishmentEndsAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("Status", "PunishmentEndsAt", "RestoredAt");
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.ReelComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<string>("Key")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("IsMarketplaceSuspended")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("IsPostSuspended")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsReelSuspended")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<DateTime?>("MarketplaceSuspendedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("MarketplaceSuspensionReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<DateTime?>("PostSuspendedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PostSuspensionReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<DateTime?>("ReelSuspendedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ReelSuspensionReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.MarketplaceFavorite", b =>
                {
                    b.HasOne("FacebookClone.Domain.Entities.MarketplaceListing", "Listing")
                        .WithMany("Favorites")
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.MarketplaceListing", b =>
                {
                    b.HasOne("FacebookClone.Domain.Entities.MarketplacePaymentTransaction", "PaymentTransaction")
                        .WithOne("Listing")
                        .HasForeignKey("FacebookClone.Domain.Entities.MarketplaceListing", "PaymentTransactionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FacebookClone.Domain.Entities.User", "Seller")
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("FacebookClone.Domain.Entities.Message", "ForwardedFromMessage")
                        .WithMany()
                        .HasForeignKey("ForwardedFromMessageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FacebookClone.Domain.Entities.Message", "ReplacesMessage")
                        .WithMany()
                        .HasForeignKey("ReplacesMessageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FacebookClone.Domain.Entities.Message", "ReplyToMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.MessageHiddenForUser", b =>
                {
                    b.HasOne("FacebookClone.Domain.Entities.Message", "Message")
            ...
            modelBuilder.Entity("FacebookClone.Domain.Entities.ModerationReport", b =>
                {
                    b.HasOne("FacebookClone.Domain.Entities.User", "Reporter")
                        .WithMany()
